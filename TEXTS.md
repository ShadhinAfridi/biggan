# Biggan.me — Complete Bilingual Platform Text Directory (প্ল্যাটফর্ম টেক্সট ডিরেক্টরি)
> **Bilingual Master Index (ইংরেজি ও বাংলা সমন্বিত টেক্সট তালিকা)**  
> Complete inventory of all user interface texts, localization keys, curriculum descriptions, scientific glossary terms, and test specifications across `biggan.me`.
> *biggan.me প্ল্যাটফর্মের সকল UI টেক্সট, অনুবাদ কি-ওয়ার্ড, শিক্ষাক্রম বিবরণী, বিজ্ঞান পরিভাষা এবং টেস্ট তালিকার পূর্ণাঙ্গ দ্বৈতভাষিক ক্যাটালগ।*

---

## 📊 Overview Statistics (সারসংক্ষেপ)

| Metric (পরিমাপক) | Count (সংখ্যা) | Coverage (আওতা) |
| :--- | :--- | :--- |
| **UI Localization Keys (ইন্টারফেস টেক্সট কি)** | **72 Keys** | 100% Bilingual (`bn` & `en` in `src/i18n/ui.ts`) |
| **Curriculum Core Subjects (মূল বিষয়সমূহ)** | **6 Subjects** | SSC (9–10) & HSC (11–12) |
| **Scientific Glossary Terms (বিজ্ঞান পরিভাষা)** | **10 Terms** | Terminology, Symbols & Definitions |
| **Automated Unit Tests (স্বয়ংক্রিয় ইউনিট টেস্ট)** | **98 Tests** | 100% Passed across 7 suites |

---

## 🧭 Table of Contents (সূচিপত্র)

1. [Part 1: UI & Localization Text Strings (ইউজার ইন্টারফেস টেক্সট)](#part-1-ui--localization-text-strings-ইউজার-ইন্টারফেস-টেক্সট)
   - [1.1 Site Brand & Metadata (ব্র্যান্ড ও মেটাডাটা)](#11-site-brand--metadata-ব্র্যান্ড-ও-মেটাডাটা)
   - [1.2 Navigation Menus (ন্যাভিগেশন মেনু)](#12-navigation-menus-ন্যাভিগেশন-মেনু)
   - [1.3 Scientific Calculators & Tools (ক্যালকুলেটর ও টুলস)](#13-scientific-calculators--tools-ক্যালকুলেটর-ও-টুলস)
   - [1.4 Page Layout Sections (পেজ লেআউট ও সেকশন)](#14-page-layout-sections-পেজ-লেআউট-ও-সেকশন)
   - [1.5 Casio Keystroke Guide (কাসিও ক্যালকুলেটর নির্দেশিকা)](#15-casio-keystroke-guide-কাসিও-ক্যালকুলেটর-নির্দেশিকা)
   - [1.6 Common UI Actions & Microcopy (সাধারণ বাটন ও মাইক্রোকপি)](#16-common-ui-actions--microcopy-সাধারণ-বাটন-ও-মাইক্রোকপি)
   - [1.7 Footer, Legal & Trust (ফুটার, শর্তাবলী ও অধিকার)](#17-footer-legal--trust-ফুটার-শর্তাবলী-ও-অধিকার)
2. [Part 2: Curriculum Taxonomy Texts (শিক্ষাক্রম ও পাঠ্যক্রম টেক্সট)](#part-2-curriculum-taxonomy-texts-শিক্ষাক্রম-ও-পাঠ্যক্রম-টেক্সট)
3. [Part 3: Scientific Glossary Terminology (বিজ্ঞান পরিভাষা ও সংজ্ঞা)](#part-3-scientific-glossary-terminology-বিজ্ঞান-পরিভাষা-ও-সংজ্ঞা)
4. [Part 4: Complete Test Text List (সকল ৯৮টি টেস্টের সম্পূর্ণ তালিকা)](#part-4-complete-test-text-list-সকল-৯৮টি-টেস্টের-সম্পূর্ণ-তালিকা)

---

## Part 1: UI & Localization Text Strings (ইউজার ইন্টারফেস টেক্সট)

### 1.1 Site Brand & Metadata (ব্র্যান্ড ও মেটাডাটা)

| Key Identifier (কি) | English Text (ইংরেজি) | বাংলা টেক্সট (Bangla) |
| :--- | :--- | :--- |
| `site.title` | Biggan.me — Step-by-Step STEM Solvers & Scientific Calculators | Biggan.me — বিজ্ঞান ও গণিত সমস্যা সমাধান ও গাণিতিক টুলস |
| `site.description` | Bilingual STEM platform featuring step-by-step LaTeX derivations, Casio fx-991 keystroke guides, and NCTB/NCERT curriculum alignment. | NCTB ও NCERT কারিকুলাম ভিত্তিক বৈজ্ঞানিক ক্যালকুলেটর, ধাপে ধাপে সমীকরণ সমাধান, কাসিও fx-991 কি-স্ট্রোক গাইড এবং দ্বৈতভাষিক সায়েন্স ডিকশনারি। |
| `site.tagline` | Every step transparent, mathematically rigorous, and exam-ready | বিজ্ঞান ও গণিতের প্রতিটি ধাপ স্পষ্ট ও নির্ভুল |

### 1.2 Navigation Menus (ন্যাভিগেশন মেনু)

| Key Identifier (কি) | English Text (ইংরেজি) | বাংলা টেক্সট (Bangla) |
| :--- | :--- | :--- |
| `nav.home` | Home | মূলপাতা |
| `nav.tools` | Calculators | ক্যালকুলেটর সমূহ |
| `nav.periodicTable` | Periodic Table | পর্যায় সারণী |
...
| `nav.progress` | My Progress | আমার অগ্রগতি |
| `nav.about` | About | পরিচিতি |
| `nav.methodology` | Methodology | পদ্ধতি ও নির্ভুলতা |

### 1.3 Scientific Calculators & Tools (ক্যালকুলেটর ও টুলস)

| Key Identifier (কি) | English Text (ইংরেজি) | বাংলা টেক্সট (Bangla) |
| :--- | :--- | :--- |
| `tools.title` | Programmatic Scientific Calculators | প্রোগ্রাম্যাটিক বিজ্ঞান ক্যালকুলেটর |
| `tools.subtitle` | Full algebraic intermediate steps, dimensional unit validation, and physical Casio exam hardware keystrokes. | প্রতিটি গণনায় পূর্ণাঙ্গ সমীকরণ প্রতিপাদন, একক বিশ্লেষণ ও কাসিও fx-991 সমাধান গাইড |
| `tools.molarMass.name` | Molar Mass & Composition Deconstructor | মোলার ভর ও শতকরা সংযুতি |
| `tools.molarMass.desc` | Calculate molecular mass of hydrates, coordination complexes, and isotopic percent compositions. | কেলাস পানিযুক্ত লবণসহ যেকোনো যৌগের মোলার ভর ও মৌলের শতকরা পরিমাণ নির্ণয়। |
| `tools.redox.name` | Ion-Electron Redox Balancer | আয়ন-ইলেকট্রন জারণ-বিজারণ সমতা |
| `tools.redox.desc` | Balance oxidation-reduction reactions in acidic and basic media via step-by-step half-reactions. | অম্লীয় ও ক্ষারীয় মাধ্যমে অর্ধ-বিক্রিয়া পদ্ধতিতে পূর্ণাঙ্গ সমতাকরণ ও ইলেকট্রন স্থানান্তর। |
| `tools.sigFigs.name` | Significant Figures Engine | তাৎপর্যপূর্ণ অঙ্ক (Sig Figs) নির্ণায়ক |
| `tools.sigFigs.desc` | Determine significant digits, scientific notation conversions, and precision-tracked arithmetic. | তাৎপর্যপূর্ণ অঙ্কের সংখ্যা গণনা, বৈজ্ঞানিক রূপান্তর এবং নির্ভুল যোগ-গুণ বিশ্লেষণ। |
| `tools.projectile.name` | Kinematic Projectile Motion Solver | প্রাস ও প্রক্ষেপক গতিবিদ্যা |
| `tools.projectile.desc` | Calculate maximum height, time of flight, range, and interactive 2D trajectory vector plots. | সর্বোচ্চ উচ্চতা, বিচরণকাল, অনুভূমিক পাল্লা ও দ্বিমাত্রিক গতিপথের ভেক্টর চিত্র। |
| `tools.quadratic.name` | Procedural Quadratic Equation Solver | দ্বিঘাত সমীকরণ ধাপে ধাপে সমাধান |
| `tools.quadratic.desc` | Real and complex roots, discriminant analysis, and completing-the-square derivations. | বাস্তব ও জটিল মূল, নিশ্চয়ক (Discriminant) বিশ্লেষণ এবং পূর্ণবর্গ পদ্ধতি। |
| `tools.htmlRunner.name` | HTML Code Playground & Live Runner | এইচটিএমএল (HTML) কোড এডিটর ও রানার |
| `tools.htmlRunner.desc` | Live responsive iframe sandbox, board exam tables (rowspan/colspan), and error fixer. | লাইভ প্রিভিউ, টেবিল (rowspan/colspan), বোর্ড প্রশ্ন ও ভুল সংশোধনের এইচটিএমএল প্লেগ্রাউন্ড। |
| `tools.cRunner.name` | C Programming Code Simulator & Memory Tracer | সি প্রোগ্রামিং (C Code) সিমুলেটর ও মেমরি ট্রেসার |
| `tools.cRunner.desc` | Step-by-step RAM variable memory tracing, loops, conditional branches, and board C algorithms. | লুপ, শর্ত ও ভ্যারিয়েবলের ধাপভিত্তিক মেমরি ট্রেস এবং এইচএসসি বোর্ড স্ট্যান্ডার্ড সি রানার। |
| `tools.dbSimulator.name` | Relational Database & SQL Simulator | রিলেশনাল ডেটাবেজ ও SQL কুয়েরি সিমুলেটর |
| `tools.dbSimulator.desc` | In-browser SQL queries, relational schemas, ER diagrams, and secondary exam databases. | ব্রাউজারে সরাসরি SQL কুয়েরি রান, টেবিল রিলেশনশিপ ও এইচএসসি বোর্ড ডেটাবেজ এক্সপ্লোরার। |
| `tools.circuitSimulator.name` | Digital Logic Gate & Circuit Simulator | ডিজিটাল লজিক গেট ও সার্কিট সিমুলেটর |
| `tools.circuitSimulator.desc` | Interactive logic gates, Half/Full Adders, universal gate circuits, and live truth tables. | লজিক গেট (AND, OR, NOT, XOR), হাফ/ফুল অ্যাডার এবং লাইভ ট্রুথ টেবিল সিমুলেটর। |
| `tools.generalMath.name` | SSC General Mathematics Solver & Equation Engine | এসএসসি সাধারণ গণিত সমাধান ও সমীকরণ ইঞ্জিন |
| `tools.generalMath.desc` | Step-by-step solver for grouped statistics (Mean, Median, Mode), trigonometry, algebra, and mensuration. | পরিসংখ্যান (গড়, মধ্যক, প্রচুরক), ত্রিকোণমিতি ও উচ্চতা, বীজগণিত ও পরিমিতির সম্পূর্ণ সমাধান। |
| `tools.physics.name` | SSC Physics Equation Suite | এসএসসি পদার্থবিজ্ঞান সমাধান ইঞ্জিন |
| `tools.physics.desc` | Complete solver covering all 13 NCTB chapters: Kinematics, Dynamics, Heat, Optics & Circuits. | ১৩টি অধ্যায়ের সম্পূর্ণ সমীকরণ সমাধান, কাসিও শর্টকাট ও বোর্ড প্রশ্নের অ্যানালাইসিস। |
| `tools.chemistry.name` | SSC Chemistry Equation Suite | এসএসসি রসায়ন সমাধান ইঞ্জিন |
| `tools.chemistry.desc` | Quantitative solver covering Graham’s Law, Bohr Model, Mole, Limiting Reactants, ΔH, and pH. | পরিমাণগত রসায়ন, ব্যাপন, মোল, মোলারিটি, সীমিত বিক্রিয়ক, ΔH ও pH সমাধানকারী। |
| `tools.biology.name` | SSC Biology Solutions Suite | এসএসসি জীববিজ্ঞান সমাধান ইঞ্জিন |
| `tools.biology.desc` | Quantitative solver for BMI, BMR, Caloric Needs, Respiration ATP, Punnett squares, and Energy. | বিএমআই, বিএমআর, শ্বসন এটিপি, পুনেট স্কয়ার ও শক্তি পিরামিডের পুঙ্খানুপুঙ্খ হিসাব। |
| `tools.higherMath.name` | SSC Higher Math Solver & Proofs | এসএসসি উচ্চতর গণিত প্রমাণ ইঞ্জিন |
| `tools.higherMath.desc` | Comprehensive solver for all 14 NCTB chapters: Apollonius, quadratics, series, binomials & geometry. | ১৪টি অধ্যায়ের সম্পূর্ণ সমাধান: এ্যাপোলোনিওস, দ্বিঘাত, ধারা, দ্বিপদী বিস্তৃতি ও ক্ষেত্রফল। |

### 1.4 Page Layout Sections (পেজ লেআউট ও সেকশন)

| Key Identifier (কি) | English Text (ইংরেজি) | বাংলা টেক্সট (Bangla) |
| :--- | :--- | :--- |
| `section.calculator` | Interactive Calculator Workspace | ইন্টারেক্টিভ গণনাকারী |
| `section.derivation` | Mathematical Foundations & Derivations | গাণিতিক ভিত্তি ও সমীকরণ প্রতিপাদন |
| `section.examples` | Solved Textbook & Board Exam Exemplars | পাঠ্যবই ও বোর্ড পরীক্ষার ৩টি সমাধানকৃত উদাহরণ |
| `section.casio` | Casio Hardware Operational Bridge | ক্যালকুলেটর কি-স্ট্রোক গাইড |
| `section.applications` | Industrial & Real-World Applications | বাস্তব ও শিল্পক্ষেত্রে প্রয়োগ |
| `section.faq` | Frequently Asked Questions (FAQ) | বহুল জিজ্ঞাসিত প্রশ্নাবলী (FAQ) |

### 1.5 Casio Keystroke Guide (কাসিও ক্যালকুলেটর নির্দেশিকা)

| Key Identifier (কি) | English Text (ইংরেজি) | বাংলা টেক্সট (Bangla) |
| :--- | :--- | :--- |
| `casio.guideTitle` | Casio fx-991 & fx-100MS Hardware Keystroke Guide | কাসিও fx-991 ও fx-100MS ফিজিক্যাল ক্যালকুলেটর কি-স্ট্রোক গাইড |
| `casio.guideSubtitle` | Exact button sequences permitted in secondary board and university entrance exams: | বোর্ড ও ভর্তি পরীক্ষায় অনুমোদিত সায়েন্টিফিক ক্যালকুলেটরে হুবহু একই হিসাব করার ধাপসমূহ: |
...
### 1.6 Common UI Actions & Microcopy (সাধারণ বাটন ও মাইক্রোকপি)

| Key Identifier (কি) | English Text (ইংরেজি) | বাংলা টেক্সট (Bangla) |
| :--- | :--- | :--- |
| `ui.calculate` | Calculate | গণনা করুন |
| `ui.clear` | Clear | মুছে ফেলুন |
| `ui.copy` | Copy | কপি করুন |
| `ui.copied` | Copied! | কপি করা হয়েছে! |
| `ui.share` | Share | শেয়ার করুন |
| `ui.print` | Print / Save PDF | প্রিন্ট বা PDF সংরক্ষণ |
| `ui.steps` | Step-by-Step Solution | ধাপে ধাপে সমাধান |
| `ui.result` | Result | ফলাফল |
| `ui.input` | Input | ইনপুট দিন |
| `ui.example` | Load Example | উদাহরণ দেখুন |
| `ui.curriculum.nctb` | NCTB (Bangladesh) | NCTB (বাংলাদেশ) |
| `ui.curriculum.ncert` | NCERT / WBCHSE (India) | NCERT / WBCHSE (ভারত) |

### 1.7 Footer, Legal & Trust (ফুটার, শর্তাবলী ও অধিকার)

| Key Identifier (কি) | English Text (ইংরেজি) | বাংলা টেক্সট (Bangla) |
| :--- | :--- | :--- |
| `footer.disclaimer` | Biggan.me is an open scientific learning utility. Calculations align with IUPAC and secondary board standards. | Biggan.me একটি উন্মুক্ত বিজ্ঞান প্ল্যাটফর্ম। সমস্ত গণনা NCTB ও IUPAC স্বীকৃত আন্তর্জাতিক মানদণ্ডে নির্মিত। |
| `footer.privacy` | Privacy Policy | গোপনীয়তা নীতি |
| `footer.terms` | Terms of Service | ব্যবহারের শর্তাবলী |
| `footer.editorial` | Editorial Standards | সম্পাদকীয় নীতিমালা |
| `footer.rights` | All rights reserved. | সর্বস্বত্ব সংরক্ষিত। |

---

## Part 2: Curriculum Taxonomy Texts (শিক্ষাক্রম ও পাঠ্যক্রম টেক্সট)

| Level | Subject Code | English Subject Name | বাংলা বিষয়ের নাম | English Description | বাংলা বিবরণ |
| :---: | :---: | :--- | :--- | :--- | :--- |
| **SSC** | SSC 136 | Physics | পদার্থবিজ্ঞান | Kinematics, dynamics, heat, waves, optics, current electricity, and modern physics. | গতিবিদ্যা, বল, কাজ-শক্তি, তরঙ্গ, আলো, চলতড়িৎ এবং আধুনিক পদার্থবিজ্ঞান। |
| **SSC** | SSC 137 | Chemistry | রসায়ন | Atomic structure, periodic table, mole concept, chemical bonds, reactions, and acid-bases. | পরমাণুর গঠন, পর্যায় সারণি, মোলের ধারণা, রাসায়নিক বন্ধন, বিক্রিয়া এবং এসিড-ক্ষারক। |
| **SSC** | SSC 138 | Biology | জীববিজ্ঞান | Cell structure, bioenergetics, nutrition, circulatory system, genetics, and ecology. | কোষ কাঠামো, জৈবশক্তি, খাদ্য ও পুষ্টি, রক্ত সংবহন, বংশগতি এবং বাস্তুতন্ত্র। |
| **SSC** | SSC 109 | General Mathematics | সাধারণ গণিত | Sets, algebraic expressions, exponents, logarithms, trigonometry, mensuration, and statistics. | সেট ও ফাংশন, বীজগণিতীয় রাশি, সূচক, লগারিদম, ত্রিকোণমিতি, পরিমিতি এবং পরিসংখ্যান। |
| **SSC** | SSC 126 | Higher Mathematics | উচ্চতর গণিত | Apollonius theorem, quadratics, infinite series, binomial expansion, coordinate geometry, and vectors. | অ্যাপোলোনিয়াসের উপপাদ্য, দ্বিঘাত সমীকরণ, অনন্ত ধারা, দ্বিপদী বিস্তৃতি, স্থানাঙ্ক জ্যামিতি ও ভেক্টর। |
| **HSC** | HSC 275 | Information & Communication Technology (ICT) | তথ্য ও যোগাযোগ প্রযুক্তি | Boolean logic gates, number systems, HTML web design, C programming, and SQL database management. | বুলিয়ান লজিক গেট, সংখ্যা পদ্ধতি, এইচটিএমএল ওয়েব ডিজাইন, সি প্রোগ্রামিং এবং এসকিউএল ডেটাবেজ। |

---

## Part 3: Scientific Glossary Terminology (বিজ্ঞান পরিভাষা ও সংজ্ঞা)

| Term ID | English Term | বাংলা পরিভাষা | English Definition | বাংলা সংজ্ঞা |
| :---: | :--- | :--- | :--- | :--- |
| `molar-mass` | **Molar Mass** | **মোলার ভর** | The mass of a given substance divided by the amount of that substance, measured in g/mol. | কোনো পদার্থের ১ মোলের (বা ৬.০২২ × ১০²³ টি কণার) সামগ্রিক ভরকে তার মোলার ভর বলে। |
| `velocity` | **Velocity** | **বেগ** | The rate of change of position of an object with respect to time in a specified direction. | নির্দিষ্ট দিকে সময়ের সাথে কোনো বস্তুর অবস্থানের পরিবর্তনের হারকে বেগ বলে। |
| `acceleration` | **Acceleration** | **ত্বরণ** | The rate at which the velocity of an object changes over time. | সময়ের সাথে কোনো বস্তুর বেগ বৃদ্ধির হারকে ত্বরণ বলে। |
| `force` | **Force** | **বল** | An interaction that causes an object of mass m to accelerate in the direction of the net applied force. | যা স্থির বস্তুর উপর ক্রিয়া করে তাকে গতিশীল করে বা করতে চায়, কিংবা গতিশীল বস্তুর গতির পরিবর্তন করে। |
| `kinetic-energy` | **Kinetic Energy** | **গতিশক্তি** | The energy possessed by an object due to its macroscopic motion. | কোনো গতিশীল বস্তু তার গতির জন্য কাজ করার যে সামর্থ্য অর্জন করে তাকে গতিশক্তি বলে। |
| `power` | **Power** | **ক্ষমতা** | The amount of energy transferred or converted per unit time. | কাজ সম্পাদনকারী কোনো সত্ত্বার কাজ করার সময়ভিত্তিক হারকে ক্ষমতা বলে। |
| `electronegativity` | **Electronegativity** | **তড়িৎ ঋণাত্মকতা** | A chemical property that describes the tendency of an atom to attract a shared pair of electrons. | সমযোজী বন্ধনের ইলেকট্রন যুগলকে কোনো পরমাণুর নিজের দিকে আকর্ষণ করার আপেক্ষিক ক্ষমতা। |
| `planck-constant` | **Planck Constant** | **প্লাঙ্কের ধ্রুবক** | Fundamental physical constant characterizing the mathematical relationship between photon energy and frequency. | কোয়ান্টাম বলবিজ্ঞানের সবচেয়ে মৌলিক ধ্রুবক ($6.626 \\times 10^{-34}\\text{ J·s}$)। |
| `electric-potential` | **Electric Potential** | **তড়িৎ বিভব** | The amount of work energy needed to move a unit of electric charge from a reference point to a specific point. | অসীম দূরত্ব থেকে প্রতি একক ধনাত্মক আধানকে তড়িৎক্ষেত্রের কোনো বিন্দুতে আনতে কৃতকাজের পরিমাণ। |
| `resistance` | **Electrical Resistance** | **বৈদ্যুতিক রোধ** | A measure of the opposition to current flow in an electrical circuit. | পরিবাহীর যে ধর্মের জন্য এর মধ্য দিয়ে বিদ্যুৎ প্রবাহ বাধাগ্রস্ত হয় তাকে রোধ বলে। |

---

## Part 4: Complete Test Text List (সকল ৯৮টি টেস্টের সম্পূর্ণ তালিকা)

> *In case this request references the test list specifications, all 98 unit tests from the test suites are indexed below in both English and Bangla:*
